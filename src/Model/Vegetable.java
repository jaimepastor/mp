...
/**
 * Subclass for the Vegetable type of Crop.
 */
public class Vegetable extends Crop{
     ...
     */
    public Vegetable(String sn, String type, double ht, int wn, int hwn, int fn, int hfn, int hc, int npp, int sc, double bp, int cb, int xp, int flb) {
